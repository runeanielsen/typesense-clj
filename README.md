...
Clojure client for [Typesense 27.1](https://github.com/typesense/typesense)
...
This section describes how to use the collection, further information can be found [here.](https://typesense.org/docs/27.1/api/collections.html#create-a-collection)

### Create collection

The different `types` for the schema can be found [here](https://typesense.org/docs/27.1/api/collections.html#create-a-collection).
...
The different `types` for the schema can be found [here](https://typesense.org/docs/27.1/api/collections.html#update-or-alter-a-collection).
...
This section describes how to use the documents, further information can be found [here.](https://typesense.org/docs/27.1/api/documents.html)
...
Create/upsert/update documents. All of them takes optional parameters, an example is setting the batch size using `:batch_size 20`. Read more [here.](https://typesense.org/docs/27.1/api/documents.html#import-documents)
...
Search for documents in a collection. You can find all the query arguments [here.](https://typesense.org/docs/27.1/api/documents.html#arguments)
...
Typesense allows you to create API Keys with fine-grain access control. You can restrict access on both a per-collection and per-action level, [read more here](https://typesense.org/docs/27.1/api/api-keys.html#create-an-api-key)
...
Using overrides, you can include or exclude specific documents for a given query, read more [here.](https://typesense.org/docs/27.1/api/curation.html)
...
An alias is a virtual collection name that points to a real collection. Read more [here](https://typesense.org/docs/27.1/api/collection-alias.html)
...
The synonyms feature allows you to define search terms that should be considered equivalent, read more [here.](https://typesense.org/docs/27.1/api/synonyms.html)
...
Typesense API exceptions in the [Typesense-api-errors](https://typesense.org/docs/27.1/api/api-errors.html) spec.
